...
const Stock = () => {
  ...
  const stockItems = [
    { name: "Laptop X200", quantity: 5 },
    { name: "Aspirin 50", quantity: 12 },
    { name: "Hand Sanitizer", quantity: 8 },
  ];
      ...
      <main className="flex-1 p-8 bg-gray-100">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3 bg-gray-200 px-4 py-2 rounded-lg w-full md:w-80">
            ...
            <input placeholder="Search stock..." className="bg-transparent outline-none w-full text-base md:text-lg font-medium" />
          </div>
