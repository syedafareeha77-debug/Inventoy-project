  ...
  return (
    <div className="flex min-h-screen font-sans">
      ...
      <main className="flex-1 p-6 bg-gray-100">
        ...
        <p className="text-gray-600">Manage all product categories here.</p>
        {/* Example Table */}
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="p-3">Electronic items and gadgets</td>
              </tr>
              <tr className="border-b">
                <td className="p-3">Medicine</td>
                <td className="p-3">Pharmaceutical products</td>
              </tr>
              <tr>
                <td className="p-3">Grocery</td>
                <td className="p-3">Daily essential groceries</td>
              </tr>
            </tbody>
          </table>
        </div>
