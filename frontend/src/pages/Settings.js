        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl shadow-xl text-center">
              <div className="relative w-32 h-32 mx-auto mb-4">
                ...
                {/* camera button */}
                <label className="absolute bottom-1 right-1 p-2 bg-emerald-500 rounded-full text-[#1a2223] border-4 border-[#1a2223] hover:scale-110 transition-transform cursor-pointer">
                  <FiCamera size={16} />
                  <input
                    type="file"
                    accept="image/*"
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 p-8 rounded-2xl shadow-xl">
              ...
              <button
                onClick={handleSave}
                className="w-full md:w-auto mt-8 flex items-center justify-center gap-2 px-8 py-3 bg-emerald-500 text-[#1a2223] font-bold rounded-xl hover:bg-emerald-400 transition-all shadow-lg shadow-emerald-500/20"
              >
